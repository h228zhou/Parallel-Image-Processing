...
There are three implementations: a sequential baseline version,
...
Image convolutions backgrounds:
...
be communicated to the program using the JSON format. If you are unfamiliar
with the JSON standard then you should read up on it before beginning the
assignment. 
How to work with JSON data inside Go is described here:
